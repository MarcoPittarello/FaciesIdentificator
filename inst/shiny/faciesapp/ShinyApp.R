...
server <- function(input, output, session) {
  ...
  observeEvent(input$file_tbd, {
    ...
    if (ext == "xlsx") {
      sheets <- excel_sheets(input$file_tbd$datapath)
  ...
  observeEvent(input$file_ref, {
    ...
    if (ext == "xlsx") {
      sheets <- excel_sheets(input$file_ref$datapath)
